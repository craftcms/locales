...
return [
	...
	'localeDisplayNames' => [
		...
		'ar-OM' => 'arabiska (Oman)',
		'ar-PS' => 'arabiska (Palestinska området)',
		'ar-QA' => 'arabiska (Qatar)',
		'ar-SA' => 'arabiska (Saudiarabien)',
		'ar-SD' => 'arabiska (Nordsudan)',
		...
		'cgg-UG' => 'chiga (Uganda)',
		'chr' => 'cherokesiska',
		'chr-US' => 'cherokesiska (Förenta staterna)',
		'cs' => 'tjeckiska',
		'cs-CZ' => 'tjeckiska (Tjeckien)',
		'cy' => 'walesiska',
		'cy-GB' => 'walesiska (Förenade kungariket)',
		'da' => 'danska',
		...
		'en-GB' => 'engelska (Förenade kungariket)',
		...
		'en-KN' => 'engelska (Saint Kitts och Nevis)',
		'en-KY' => 'engelska (Caymanöarna)',
		'en-LC' => 'engelska (Saint Lucia)',
		...
		'en-US-POSIX' => 'engelska (Förenta staterna, POSIX)',
		'en-VC' => 'engelska (Saint Vincent och Grenadinerna)',
		...
		'es-US' => 'spanska (Förenta staterna)',
		...
		'fr-CD' => 'franska (Demokratiska republiken Kongo)',
		...
		'fr-MF' => 'franska (S:t Martin [franska delen])',
		...
		'fr-PM' => 'franska (Saint Pierre och Miquelon)',
		...
		'fr-WF' => 'franska (Wallis- och Futuna)',
		...
		'ha' => 'hausa',
		'ha-Latn' => 'hausa (latinska)',
		'ha-Latn-GH' => 'hausa (latinska, Ghana)',
		'ha-Latn-NE' => 'hausa (latinska, Niger)',
		'ha-Latn-NG' => 'hausa (latinska, Nigeria)',
		'haw' => 'hawaiiska',
		'haw-US' => 'hawaiiska (Förenta staterna)',
		'he' => 'hebreiska',
		...
		'ki-KE' => 'kikuyu (Kenya)',
		'kk' => 'kazakiska',
		'kk-Cyrl' => 'kazakiska (kyrilliska)',
		'kk-Cyrl-KZ' => 'kazakiska (kyrilliska, Kazakstan)',
		'kkj' => 'mkako',
		...
		'ks' => 'kashmiri',
		'ks-Arab' => 'kashmiri (arabiska)',
		'ks-Arab-IN' => 'kashmiri (arabiska, Indien)',
		'ksb' => 'kisambaa',
		'ksb-TZ' => 'kisambaa (Tanzania)',
		'ksf' => 'bafia',
		'ksf-CM' => 'bafia (Kamerun)',
		'kw' => 'korniska',
		'kw-GB' => 'korniska (Förenade kungariket)',
		'ky' => 'kirgiziska',
		'ky-Cyrl' => 'kirgiziska (kyrilliska)',
		'ky-Cyrl-KG' => 'kirgiziska (kyrilliska, Kirgizistan)',
		'lag' => 'langi',
		'lag-TZ' => 'langi (Tanzania)',
		'lg' => 'luganda',
		'lg-UG' => 'luganda (Uganda)',
		'lkt' => 'lkt',
		'lkt-US' => 'lkt (Förenta staterna)',
		'ln' => 'lingala',
		'ln-AO' => 'lingala (Angola)',
		'ln-CD' => 'lingala (Demokratiska republiken Kongo)',
		...
		'lu' => 'luba-katanga',
		'lu-CD' => 'luba-katanga (Demokratiska republiken Kongo)',
		'luo' => 'luo',
		'luo-KE' => 'luo (Kenya)',
		'luy' => 'luhya',
		'luy-KE' => 'luhya (Kenya)',
		...
		'mn-Cyrl-MN' => 'mongoliska (kyrilliska, Mongoliet)',
		'mr' => 'marathi',
		'mr-IN' => 'marathi (Indien)',
		'ms' => 'malajiska',
		'ms-Latn' => 'malajiska (latinska)',
		'ms-Latn-BN' => 'malajiska (latinska, Brunei)',
		'ms-Latn-MY' => 'malajiska (latinska, Malaysia)',
		'ms-Latn-SG' => 'malajiska (latinska, Singapore)',
		'mt' => 'maltesiska',
		'mt-MT' => 'maltesiska (Malta)',
		'mua' => 'mundang',
		'mua-CM' => 'mundang (Kamerun)',
		'my' => 'burmesiska',
		'my-MM' => 'burmesiska (Burma)',
		'naq' => 'nama',
		'naq-NA' => 'nama (Namibia)',
		'nb' => 'bokmål',
		'nb-NO' => 'bokmål (Norge)',
		'nb-SJ' => 'bokmål (Svalbard och Jan Mayen)',
		'nd' => 'nordndebele',
		...
		'or-IN' => 'oriya (Indien)',
		'pa' => 'panjabi',
		'pa-Arab' => 'panjabi (arabiska)',
		'pa-Arab-PK' => 'panjabi (arabiska, Pakistan)',
		'pa-Guru' => 'panjabi (gurmukhi)',
		'pa-Guru-IN' => 'panjabi (gurmukhi, Indien)',
		'pl' => 'polska',
		'pl-PL' => 'polska (Polen)',
		'ps' => 'pashto',
		...
		'swc' => 'Kongo-swahili',
		'swc-CD' => 'Kongo-swahili (Demokratiska republiken Kongo)',
		'ta' => 'tamil',
		'ta-IN' => 'tamil (Indien)',
		...
		'th-TH' => 'thai (Thailand)',
		'ti' => 'tigrinska',
		'ti-ER' => 'tigrinska (Eritrea)',
		'ti-ET' => 'tigrinska (Etiopien)',
		'to' => 'tonganska',
		...
		'tzm-Latn' => 'centralmarockansk tamazight (latinska)',
		'tzm-Latn-MA' => 'centralmarockansk tamazight (latinska, Marocko)',
		'uk' => 'ukrainska',
