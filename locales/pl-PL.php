...
return [
	...
	'localeDisplayNames' => [
		...
		'en-GG' => 'angielski (Wyspa Guernsey)',
		...
		'ha' => 'hausa',
		'ha-Latn' => 'hausa (łacińskie)',
		'ha-Latn-GH' => 'hausa (łacińskie, Ghana)',
		'ha-Latn-NE' => 'hausa (łacińskie, Niger)',
		'ha-Latn-NG' => 'hausa (łacińskie, Nigeria)',
		'haw' => 'hawajski',
		...
		'kk-Cyrl-KZ' => 'kazachski (cyrylica, Kazachstan)',
		'kkj' => 'kako',
		'kkj-CM' => 'kako (Kamerun)',
		'kl' => 'grenlandzki',
		...
		'ks-Arab-IN' => 'kaszmirski (arabskie, Indie)',
		'ksb' => 'sambala',
		...
		'ky' => 'kirgiski',
		'ky-Cyrl' => 'kirgiski (cyrylica)',
		'ky-Cyrl-KG' => 'kirgiski (cyrylica, Kirgistan)',
		'lag' => 'langi',
		'lag-TZ' => 'langi (Tanzania)',
		'lg' => 'ganda',
		'lg-UG' => 'ganda (Uganda)',
		'lkt' => 'lkt',
		'lkt-US' => 'lkt (Stany Zjednoczone)',
		'ln' => 'lingala',
		...
		'mn-Cyrl-MN' => 'mongolski (cyrylica, Mongolia)',
		'mr' => 'marathi',
		'mr-IN' => 'marathi (Indie)',
		'ms' => 'malajski',
		'ms-Latn' => 'malajski (łacińskie)',
		'ms-Latn-BN' => 'malajski (łacińskie, Brunei Darussalam)',
		'ms-Latn-MY' => 'malajski (łacińskie, Malezja)',
		'ms-Latn-SG' => 'malajski (łacińskie, Singapur)',
		'mt' => 'maltański',
		...
		'swc-CD' => 'kongijski suahili (Demokratyczna Republika Konga)',
		'ta' => 'tamilski',
		...
		'tzm-Latn' => 'centralnomarokański tamazight (łacińskie)',
		'tzm-Latn-MA' => 'centralnomarokański tamazight (łacińskie, Maroko)',
		'uk' => 'ukraiński',
		...
		'zh-Hans-HK' => 'chiński (uproszczone, Hongkong SAR)',
		'zh-Hans-MO' => 'chiński (uproszczone, Makau SAR)',
		'zh-Hans-SG' => 'chiński (uproszczone, Singapur)',
		'zh-Hant' => 'chiński (tradycyjne)',
		'zh-Hant-HK' => 'chiński (tradycyjne, Hongkong SAR)',
		'zh-Hant-MO' => 'chiński (tradycyjne, Makau SAR)',
