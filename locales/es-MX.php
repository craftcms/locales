...
return [
    ...
    'localeDisplayNames' => [
        ...
        'en-UG' => 'inglés (Uganda)',
        'en-UM' => 'inglés (Islas Ultramarinas Menores de Estados Unidos)',
        ...
        'yi' => 'yídish',
        'yi-001' => 'yídish (2.1.21.97)',
        'yo' => 'yoruba',
        'yo-BJ' => 'yoruba (Benín)',
        'yo-NG' => 'yoruba (Nigeria)',
        'yue' => 'cantonés',
        'yue-HK' => 'cantonés (Región Administrativa Especial de Hong Kong de la República Popular China)',
        'zgh' => 'tamazight estándar marroquí',
        'zgh-MA' => 'tamazight estándar marroquí (Marruecos)',
        'zh' => 'chino',
        'zh-Hans' => 'chino (simplificado)',
        'zh-Hans-CN' => 'chino (simplificado, China)',
        'zh-Hans-HK' => 'chino (simplificado, Región Administrativa Especial de Hong Kong de la República Popular China)',
        'zh-Hans-MO' => 'chino (simplificado, Región Administrativa Especial de Macao de la República Popular China)',
        'zh-Hans-SG' => 'chino (simplificado, Singapur)',
        'zh-Hant' => 'chino (tradicional)',
        'zh-Hant-HK' => 'chino (tradicional, Región Administrativa Especial de Hong Kong de la República Popular China)',
        'zh-Hant-MO' => 'chino (tradicional, Región Administrativa Especial de Macao de la República Popular China)',
